...
<!-- top-brands -->
<?php if($HotOffers) : //вдруг нету горячих товаров?>
                ...
                <div class="hover14 column">
                    <div class="agile_top_brand_left_grid">
                        <div class="agile_top_brand_left_grid_pos">
                            <!-- вывод иконки гор. товаров (путь и дополнительные парраметры)-->
                            ...
                            <figure>
                                <div class="snipcart-item block" >
                                    <div class="snipcart-thumb">
                                        ...
                                        <p><?= $offer->title //выводим наименование товара?></p>
                                        <h4>
                                            $<?= $offer->price //выводим цену?>
                                            <?php if((float)$offer->old_price) : //условие вывода старой цены (при значении больше 0)?>
                                            <span>$<?= $offer->old_price ?></span>
                                            <?php endif; ?>
                                        </h4>
                                    </div>
                                    <div class="snipcart-details top_brand_home_details">
                                        <a href="<?= \yii\helpers\Url::to(['cart/add', 'id' => $offer->id]) ?>" data-id="<?= $offer->id ?>" class="button add-to-cart">По ебалу щелк!</a>
                                    </div>
                                </div>
                            </figure>
                        </div>
