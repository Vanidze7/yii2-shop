        ...
        <div class="privacy about">
            ...
            <div class="checkout-right">
                ...
                <div class="cart-table">
                    ...
                    <?php $i++; endforeach; //прибавляем значение к выводимому номеру товара?>
                    </tbody>
                </table>
                </div>
            </div>
            <div class="checkout-left">
                ...
                <div class="col-md-8 address_form_agile">
                    ...
                    <?php $form = \yii\widgets\ActiveForm::begin();//виджет формы
                    echo $form->field($order, 'name');//поля формы
                    echo $form->field($order, 'email');
                    echo $form->field($order, 'phone');
                    echo $form->field($order, 'address');
                    echo $form->field($order, 'note')->textarea();
                    echo \yii\helpers\Html::submitButton('Заказать', ['class' => 'submit check_out']);//кнопка
